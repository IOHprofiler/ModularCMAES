...
inline std::string to_string(CenterPlacement s)
{
    ...
    case CenterPlacement::MAXIMIN_TABOO:
        return "MAXIMIN_TABOO";
    }
    return "unknown";
}

inline std::string to_string(RepellingType s)
{
    switch (s)
    {
    case RepellingType::NONE:
        return "NONE";
    case RepellingType::COVERAGE:
        return "COVERAGE";
    case RepellingType::ADAPTIVE:
        return "ADAPTIVE";
    }
    return "unknown";
}
...
inline std::string to_string(const Modules &mod)
{
    ...
    ss << " repelling_type: " << parameters::to_string(mod.repelling_type);
...
template <typename T> std::string to_string(const std::optional<T> &t)
{
    if (!t)
        return "None";
