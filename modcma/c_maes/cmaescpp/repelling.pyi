...
class TabooPoint:
    ...
    def rejects(self, xi: numpy.ndarray, p, attempts: int) -> bool: ...
    def shares_basin(
        self,
...
def euclidian(u: numpy.ndarray, v: numpy.ndarray) -> float: ...
...
def manhattan(u: numpy.ndarray, v: numpy.ndarray) -> float: ...
