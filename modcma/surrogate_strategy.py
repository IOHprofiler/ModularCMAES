...
from typing import Callable, List, Union, Self
...
from .parameters import LQSurrogateStrategySettings
...
class PopulationRepresentation:
    ...
    def __init__(self,
                 ...
                 surrogate_function: SurrogateModelBase,
        ...
        self.surrogate: SurrogateModelBase = surrogate_function
