...
namespace acmaes {
    ...
    AcmaesOptimizer::AcmaesOptimizer(long runid_, Fitness* fitfun_, int popsize_, int mu_,
        ...
        AcmaesOptimizer::~AcmaesOptimizer() {
            delete rs;
        }
        ...
        bool AcmaesOptimizer::updateEvolutionPaths(const vec& zmean, const vec& xold) {
        ...
        double AcmaesOptimizer::updateCovariance(bool hsig, const mat& bestArx, const mat& arz,
        ...
        void AcmaesOptimizer::updateBD(double negccov) {
        ...
        mat AcmaesOptimizer::ask_all() { // undecoded
        ...
        int AcmaesOptimizer::tell_all(mat ys, mat xs) {
            told = 0;
        ...
        int AcmaesOptimizer::tell_all_asked(mat ys, mat xs) {
            told = 0;
            for (int p = 0; p < popsize; p++)
                tell(ys(p), xs.col(p));
            computeArz = false;
        ...
        mat AcmaesOptimizer::getPopulation() {
            mat pop(dim, popsize);
            for (int p = 0; p < popsize; p++)
        ...
        int AcmaesOptimizer::tell(double y, const vec& x) {
        ...
        void AcmaesOptimizer::updateCMA() {
        ...
        int AcmaesOptimizer::doOptimize() {
        ...
        int AcmaesOptimizer::do_optimize_delayed_update(int workers) {
            //iterations = 0;
            //fitfun->resetEvaluations();
        ...
        vec AcmaesOptimizer::getBestX() {
            return bestX;
        }

        double AcmaesOptimizer::getBestValue() {
            return bestValue;
        }

        double AcmaesOptimizer::getIterations() {
            return iterations;
        }

        int AcmaesOptimizer::getStop() {
            return stop;
        }

        Fitness* AcmaesOptimizer::getFitfun() {
            return fitfun;
        }

        int AcmaesOptimizer::getDim() {
            return dim;
        }

        int AcmaesOptimizer::getPopsize() {
            return popsize;
        }

        Fitness* AcmaesOptimizer::getFitfunPar() {
            return fitfun;
        }
}
