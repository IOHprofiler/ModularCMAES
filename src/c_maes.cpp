...
bool ModularCMAES::step(FunctionType& objective)
{
...
void ModularCMAES::operator()(FunctionType& objective)
{
...
bool ModularCMAES::break_conditions() const
{
    ...
    const auto restart_strategy_criteria = p->settings.modules.restart_strategy == parameters::RestartStrategyType::STOP and p->restart->criteria.any;
